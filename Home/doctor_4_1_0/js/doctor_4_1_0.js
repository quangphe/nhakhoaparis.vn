...
const getDoctor = async () => {
    ...
    doctorJSON.map((item) => {
        ...
        doctor.push({ title: info1_ct[0], name: info1_ct[1], image: info1_ct[2], imageMB: info1_ct[3], group: sub });
    });
    return doctor;
};
        ...
        <div class="slide_item">
            <div class="doctor_4_1_0__item row">
                ...
                <div class="col-lg-6 doctor_4_1_0__pic">
                    <picture>
                        <source media="(min-width:600px)" srcset="https://cdn.nhakhoaparis.vn/${cateName[0].image}">
                        <img width="556" height="480" src="https://cdn.nhakhoaparis.vn/${cateName[0].imageMB}"
...
window.onload = async () => {
    const doctorMain = await getDoctor();
    renderDataDoctor(doctorMain, "PHILIPPE TAROT");
    ...
    tabLinks.forEach(function (el) {
        el.addEventListener("click", function () {
            ...
            renderDataDoctor(doctorMain, element);
        });
    });
}
