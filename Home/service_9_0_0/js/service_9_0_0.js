            ...
            <div class="service_9_0_0__item row">
                <div class="col-lg-4 service_9_0_0__content">
                    <div class="service_9_0_0__pic">
                        <img width="353" height="395" src="${mainService[0].pushSv[0].imgPic}" alt="" loading="lazy">
                        <div class="service_9_0_0__icon">
                            <img width="71" height="71" src="https://cdn.nhakhoaparis.vn/${mainService[0].pushSv[0].icon}" alt="" loading="lazy">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 service_9_0_0__content">
                    <div class="service_9_0_0__pic">
                        <img width="353" height="395" src="${mainService[0].pushSv[1].imgPic}" alt="" loading="lazy">
                        <div class="service_9_0_0__icon">
                            <img width="70" height="71" src="https://cdn.nhakhoaparis.vn/${mainService[0].pushSv[1].icon}" alt="" loading="lazy">
                        </div>
                    </div>
                    <div class="service_9_0_0__text">
                ...
                <div class="col-lg-4 service_9_0_0__content">
                    <div class="service_9_0_0__pic">
                        <img width="353" height="395" src="${mainService[0].pushSv[2].imgPic}" alt="" loading="lazy">
                        <div class="service_9_0_0__icon">
                            <img width="71" height="71" src="https://cdn.nhakhoaparis.vn/${mainService[0].pushSv[2].icon}" alt="" loading="lazy">
                        </div>
                    </div>
                    <div class="service_9_0_0__text">
...
window.onload = async () => {
    const serviceMain = await getService();
    renderDataService(serviceMain, "Niềng răng");
    ...
    tabLinks.forEach(function (el) {
        el.addEventListener("click", function () {
            ...
            renderDataService(serviceMain, element);
        });
    });
}