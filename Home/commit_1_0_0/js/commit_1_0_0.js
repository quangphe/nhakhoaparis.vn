document.addEventListener("DOMContentLoaded", function() {
        ...
        let html = `
            <div class="commit_1_0_0__box2__item">
                ...
                <div class="commit_1_0_0__box2__ct">
                    ...
                    <a class="commit_1_0_0__box2__more popup_regist btnnktv popupRegistSlide">
                        <span>
                            <b>Đăng ký tư vấn</b>
                        </span>
                    </a>
    ...
    function fixResponsive(){
        const itemTabs = document.querySelectorAll('.commit_1_0_0__box1__tabs .tab');
        const items = document.querySelectorAll('.commit_1_0_0__box1__tabsTitle');
